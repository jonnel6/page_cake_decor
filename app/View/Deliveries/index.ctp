<div class="deliveries index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('hora_pedido'); ?></th>
			<th><?php echo $this->Paginator->sort('hora_entrega'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($delivery['Delivery']['destino']); ?>&nbsp;</td>
		<td><?php echo h($delivery['Delivery']['hora_pedido']); ?>&nbsp;</td>
		<td><?php echo h($delivery['Delivery']['hora_entrega']); ?>&nbsp;</td>
		<td class="actions">
