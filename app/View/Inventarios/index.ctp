<div class="inventarios index">
	...
	<tr>
		...
		<td><?php echo h($inventario['Inventario']['stock']); ?>&nbsp;</td>
		<td><?php echo h($inventario['Inventario']['modified']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $inventario['Inventario']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $inventario['Inventario']['id'])); ?>
